...
func (p *Plugin) initializeAPI() {
	...
	syncAPI.HandleFunc("/nodes", p.handleListSyncNodes).Methods(http.MethodGet)
	syncAPI.HandleFunc("/nodes/{externalID}", p.handleGetSyncNode).Methods(http.MethodGet)
	syncAPI.HandleFunc("/nodes/{externalID}/children", p.handleGetSyncNodeChildren).Methods(http.MethodGet)
	syncAPI.HandleFunc("/nodes/{externalID}/members", p.handleGetSyncNodeMembers).Methods(http.MethodGet)
	syncAPI.HandleFunc("/users/{externalUserID}/nodes", p.handleGetSyncUserNodes).Methods(http.MethodGet)
